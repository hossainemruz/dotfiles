...
security/reliability risk, simplification opportunities, and consistency with
the selected research approach when relevant. Write actionable findings and
verdict to `review.md`, preserving its structure. Do not fix code unless
explicitly asked.
