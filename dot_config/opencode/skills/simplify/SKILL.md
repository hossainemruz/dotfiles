...
- Prefer FFF for file/content discovery, LSP for symbol navigation, and ast-grep for structural searches; use `glob`/`grep` only for exact-glob or regex fallback.
