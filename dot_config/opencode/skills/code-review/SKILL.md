...
- For a Task PR review, run `taskctl pr context` once and require a branch-associated completed PR. Treat its projection as the working contract; read only artifact sections not already represented there and do not load all of `plan.md` by default.
