...
- Never call the Devcroft MCP or run `taskctl`. Task lifecycle and persistence belong only to Orchestrator; callers must supply any Task context needed for validation.
