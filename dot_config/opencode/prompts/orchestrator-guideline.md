...
- Use `@builder` as the default implementation specialist, including for difficult or cross-cutting work after consequential decisions are settled. Reserve `@builder-high` for exceptional work that is both among the system's highest-impact, most critical changes and still beyond Builder's reliable capability after focused Advisor guidance. Difficulty, breadth, risk, or unfamiliarity alone is insufficient; if uncertain, use Builder.
