...
3. Choose direct implementation, Builder, or Builder-high using the routing rules. For delegated work, supply the frozen contract, relevant requirements and research, applicable durable decisions, accepted dependency outcomes, repository evidence, scope limits, feedback, and validation expectations, then retain the Builder session ID for review and human feedback.
