...
**Purpose:** Perform a focused, evidence-based review of code changes against the active sub-task and write actionable findings to the current task artifact `review.md`.
...
- Do not review code inline yourself. Always delegate the actual review reasoning to `@explore` subagents and reserve this agent for scoping, depth selection, and aggregating findings into artifact `review.md`.
...
- Do not edit any file other than artifact `review.md`.
